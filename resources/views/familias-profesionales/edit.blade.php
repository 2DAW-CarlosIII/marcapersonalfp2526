        ...
        <div class="offset-md-3 col-md-6">
            <div class="card">
                ...
                <div class="card-body" style="padding:30px">
                    ...
                    <form action="{{ action([App\Http\Controllers\FamiliasProfesionalesController::class, 'putCreate'],  ['id' => $familia_profesional->id]) }}" method="POST" enctype="multipart/form-data">
